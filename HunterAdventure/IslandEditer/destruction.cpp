...
namespace
{
	const char* TEXTURE[CDestruction::TYPE_MAX] =		// テクスチャ
	{
		"data\\TEXTURE\\Platform\\Dstr001.png",		// トゲトゲ
		"data\\TEXTURE\\Platform\\Dstr002.png",		// フワフワ
		"data\\TEXTURE\\Platform\\Dstr003.png",		// 爆発
	};
}
