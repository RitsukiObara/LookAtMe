...
CLight::CLight()
{
	...
	// ライトの情報
	ZeroMemory(&m_lightCamera, sizeof(D3DLIGHT9));
}
...
HRESULT CLight::Init(void)
{
	...
	// ライトの拡散光を設定
	m_lightCamera.Diffuse = LIGHT_DIFFUSE[0];
...
// カメラライトの取得処理
//=========================
D3DLIGHT9 CLight::GetCameraLight(void) const
{
	// カメラライトの情報を返す
...
// カメラライトの設定処理
//=========================
void CLight::SetCameraLight(const D3DLIGHT9& light)
{
	// ライトの情報を設定する
	m_lightCamera = light;
}
