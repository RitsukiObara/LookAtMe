...
namespace
{
	...
	{
		"data\\TEXTURE\\Platform\\effect000.jpg",		// 通常
		"data\\TEXTURE\\Platform\\Smoke.tga",			// 炎系
		"data\\TEXTURE\\Platform\\Dust.tga",			// 埃
		"data\\TEXTURE\\Platform\\Rupture.tga",			// 破裂
		"data\\TEXTURE\\Platform\\Smoke.tga",			// 煙
		"data\\TEXTURE\\Platform\\PopSmoke.tga",		// 煙(アニメ調)
	};
	const float DUST_GRAVITY = 0.4f;		// 埃の重力
}
...
void CEffect::SetData(const D3DXVECTOR3& pos, const D3DXVECTOR3& move, const int nLife, const float fRadius, const TYPE type, const D3DXCOLOR& col, const bool bAdd, const bool bZTest)
{
	...
	SetPos(pos);			// 位置
	SetPosOld(pos);			// 前回の位置
	SetSize(D3DXVECTOR3(fRadius, fRadius, 0.0f));	// サイズ
