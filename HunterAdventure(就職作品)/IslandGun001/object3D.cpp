...
// オーバーロードコンストラクタ
//=========================================
CObject3D::CObject3D(CObject::TYPE type, PRIORITY priority) : CObject(type, DIM_3D, priority)
{
	// 全ての値をクリアする
...
// マトリックスポインタの取得処理
//===========================================
D3DXMATRIX* CObject3D::GetMatrixPoint(void)
{
	// ワールドマトリックスのポインタを返す
	return &m_mtxWorld;
}
...
// 頂点情報の設定(決め打ち)
//===========================================
void CObject3D::SetVertexHardCoding(const D3DXVECTOR3& leftUp, const D3DXVECTOR3& rightUp, const D3DXVECTOR3& leftDown, const D3DXVECTOR3& rightDown)
{
	VERTEX_3D * pVtx;											//頂点情報へのポインタ
...
// 下中心の頂点座標の設定処理
//===========================================
void CObject3D::SetVertexUnder(void)
{
	VERTEX_3D * pVtx;			// 頂点情報へのポインタ
	...
	// 頂点座標の設定
	pVtx[0].pos = D3DXVECTOR3(-m_size.x, +m_size.y * 2.0f, +m_size.z);
	pVtx[1].pos = D3DXVECTOR3(+m_size.x, +m_size.y * 2.0f, +m_size.z);
