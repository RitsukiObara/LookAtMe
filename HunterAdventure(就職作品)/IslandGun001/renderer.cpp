...
{
	// ローカルオブジェクトを生成
	CRenderer* pRenderer = nullptr;		// レンダラーのインスタンスを生成
...
{
	//フォグの設定
	m_pD3DDevice->SetRenderState(D3DRS_FOGENABLE, bFog);	//フォグ：ON
	m_pD3DDevice->SetRenderState(D3DRS_FOGCOLOR, col);		//白色で不透明
